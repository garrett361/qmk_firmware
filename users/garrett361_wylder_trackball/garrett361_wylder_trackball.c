...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT_garrett361_wylder_trackball(
    ...
    [NAV] = LAYOUT_garrett361_wylder_trackball(
    ...
    [SYM_1] = LAYOUT_garrett361_wylder_trackball(
    ...
    [MOUSE] = LAYOUT_garrett361_wylder_trackball(
    ...
    [BOOT_1] = LAYOUT_garrett361_wylder_trackball(
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
                                _______,    _______,    _______,                               _______,    LT(BOOT_2, KC_NO),    _______
    ),
    [BOOT_2] = LAYOUT_garrett361_wylder_trackball(
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
