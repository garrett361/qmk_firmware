...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT_garrett361(
        ...
        LT(NAV, KC_ENT), LT(NUM, KC_BSPC), LT(MOUSE, KC_ESC),                                                        LT(SYM_2, KC_DEL),  KC_SPC, LT(SYM_1, KC_TAB)
    ),
    [NUM] = LAYOUT_garrett361(
        _______,    _______,    _______,    _______,    _______,                               KC_HASH,    KC_7,       KC_8,       KC_9,    _______,
        _______,    _______,    _______,    _______,    _______,                               KC_EXLM,    KC_4,       KC_5,       KC_6,    KC_GRV,
        _______,    _______,    _______,    _______,    _______,                               KC_AT,      KC_1,       KC_2,       KC_3,    _______,
    ...
    [NAV] = LAYOUT_garrett361
        ...
        _______,    _______,    _______,    _______,    _______,                               KC_PIPE,    KC_PERC,    KC_CIRC,    KC_DLR,     KC_BSLS,
