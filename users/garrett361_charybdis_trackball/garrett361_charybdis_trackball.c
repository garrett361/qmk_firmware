...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MOUSE] = LAYOUT_garrett361_charybdis_trackball(
        _______,    _______,    _______,    SNIPING,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
                                KC_BTN3,    KC_BTN1,    KC_BTN2,                               _______,    _______,    _______
    ),
    [BOOT_1] = LAYOUT_garrett361_charybdis_trackball(
        DRG_TOG,    _______,    _______,    _______,    _______,                               _______,    _______,    _______,    _______,    _______,
